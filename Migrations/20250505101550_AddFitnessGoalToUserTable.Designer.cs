...
namespace BiteWiseWeb2.Migrations
{
    ...
    [Migration("20250505101550_AddFitnessGoalToUserTable")]
    partial class AddFitnessGoalToUserTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BiteWiseWeb2.Data.DailySummary", b =>
                {
            ...
            modelBuilder.Entity("BiteWiseWeb2.Data.Exercise", b =>
                {
            ...
            modelBuilder.Entity("BiteWiseWeb2.Data.Food", b =>
                {
            ...
            modelBuilder.Entity("BiteWiseWeb2.Data.FoodLog", b =>
                {
                    b.Property<int>("RecordId")
                        .HasColumnType("int")
                        .HasColumnName("Record_Id");

                    b.Property<string>("CalsConsumed")
                        .IsRequired()
                        .HasMaxLength(10)
            ...
            modelBuilder.Entity("BiteWiseWeb2.Data.Goal", b =>
                {
            ...
            modelBuilder.Entity("BiteWiseWeb2.Data.JamaicanRecipe", b =>
                {
            ...
            modelBuilder.Entity("BiteWiseWeb2.Data.Meal", b =>
                {
            ...
            modelBuilder.Entity("BiteWiseWeb2.Data.User", b =>
                {
                    b.Property<int>("UserId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("BiteWiseWeb2.Data.UserInfoDetail", b =>
                {
                    b.Property<int?>("Age")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BiteWiseWeb2.Data.UserMeasurement", b =>
                {
            ...
            modelBuilder.Entity("BiteWiseWeb2.Data.UserPicture", b =>
                {
                    b.Property<int>("UserId")
                        .HasColumnType("int")
                        .HasColumnName("user_Id");
            ...
            modelBuilder.Entity("BiteWiseWeb2.Data.UserPreference", b =>
                {
            ...
            modelBuilder.Entity("BiteWiseWeb2.Data.UserWorkLog", b =>
                {
                    b.Property<string>("Category")
                        .HasMaxLength(100)
                        .IsUnicode(false)
            ...
            modelBuilder.Entity("BiteWiseWeb2.Data.WorkoutLog", b =>
                {
            ...
            modelBuilder.Entity("BiteWiseWeb2.Data.DailySummary", b =>
                {
                    b.HasOne("BiteWiseWeb2.Data.User", "User")
            ...
            modelBuilder.Entity("BiteWiseWeb2.Data.Meal", b =>
                {
                    b.HasOne("BiteWiseWeb2.Data.Food", "Food")
                        .WithMany("Meals")
            ...
            modelBuilder.Entity("BiteWiseWeb2.Data.UserPicture", b =>
                {
                    b.HasOne("BiteWiseWeb2.Data.User", "User")
                        .WithOne("UserPicture")
                        .HasForeignKey("BiteWiseWeb2.Data.UserPicture", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
            ...
            modelBuilder.Entity("BiteWiseWeb2.Data.WorkoutLog", b =>
                {
                    b.HasOne("BiteWiseWeb2.Data.Exercise", "Exercise")
